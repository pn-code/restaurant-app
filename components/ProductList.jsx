...
const ProductList = () => {
    return (
        ...
        <div className="flex items-center py-5 px-[10px] flex-col">
            <h1 className="text-center font-bold text-3xl mb-5">The best food in town!</h1>
            <p className="w-[90%] text-center sm:w-[70%] text-[24px] mb-10 text-gray-700 font-semibold">
