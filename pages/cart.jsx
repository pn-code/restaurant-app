  ...
  return (
    ...
    <main className="bg-gray-50">
      ...
      <div className="flex flex-col gap-8 p-12 lg:flex-row">
        ...
        {/* Right */}
        <div className="w-full text-center sm:text-left flex-1 bg-black/90 rounded-md flex">
          {/* Wrapper */}
          <div className="w-full p-14 pt-[16px] max-h-[300px] rounded-md text-white text-[18px]">
            ...
            {/* Subtotal Text */}
            <div>
              <b className="mr-[10px]">Subtotal: </b> ${cart.total}.00
            </div>
            {/* Discount Text */}
            <div>
            ...
            {open ? (
              ...
              <div className="mt-[10px] flex flex-col">
                <button
                  ...
                  className="p-2 mt-4 cursor-pointer mb-2 bg-white text-gray-800 font-bold rounded-md hover:bg-black/90 hover:text-white ease-linear duration-200 border-2 border-transparent hover:border-white"
                >
              ...
              <button
                ...
                className=" w-full px-4 py-2 text-gray-900 font-bold cursor-pointer bg-white mt-6 rounded-md border-4 border-transparent hover:border-gray-50 hover:bg-black/90 hover:text-white ease-out duration-150"
              >
                Checkout
              </button>
            )}
